...
//----------------------------------------------------------------------------------------------------------------------------------------
void SCI_Func::SCI_setting(string mode, string clock, string datlen, string enpar, string par, string stobilen, string datdir)
{
	sel_Mode(mode);
	sel_Clock(clock);
	sel_DatLen(datlen);
...
//----------------------------------------------------------------------------------------------------------------------------------------
void SCI_Func::SCI_setting(string mode, string clock, string datdir)
{
	sel_Mode(mode);
	sel_Clock(clock);
	//sel_CountSource(countsrc);
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
void SCI_Func::SCI_ProcDatAsynTrans(sc_bv<8> data_buffTrans, sc_bv<12> &data)
{
	bool parity = true;
	//sc_bv<12> data_temp;
...
//----------------------------------------------------------------------------------------------------------------------------------------------------
void SCI_Func::SCI_ProcDatAsynRecei(sc_bv<12> data_recei, sc_bv<8> &data)
{
	int check_parity;
